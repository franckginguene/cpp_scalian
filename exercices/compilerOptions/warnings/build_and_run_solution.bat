...
set VCDIR=C:\Program Files (x86)\Microsoft Visual Studio\2019\Professional
...
start /WAIT /B %QTDIR% qmake.exe -tp vc -r warnings.pro

start /WAIT "Visual" devenv warnings.vcxproj
